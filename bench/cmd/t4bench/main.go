...
// It works against any etcd-compatible endpoint, including T4, making it
// suitable for honest side-by-side comparisons.
//
// Usage:
//
//	t4bench [flags]                 # run a workload
//	t4bench compare [--results f]   # print comparison table from a JSONL file
package main
...
func runCompare(args []string) {
	...
	for _, sc := range scenarios {
		...
		for _, wl := range workloads {
			...
			// order rows by system list so t4 vs etcd is consistent
