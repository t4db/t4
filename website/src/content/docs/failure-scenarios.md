...
description: How T4 behaves under leader crash, follower crash, S3 unavailability, network partitions, WAL/checkpoint corruption, and full cluster restarts — with recovery steps.
---
